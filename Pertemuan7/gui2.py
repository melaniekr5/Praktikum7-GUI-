...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(240, 40, 201, 16))
        self.label.setObjectName("label")
        self.nameEdit = QtWidgets.QLineEdit(Form)
        self.nameEdit.setGeometry(QtCore.QRect(210, 70, 251, 21))
        self.nameEdit.setObjectName("nameEdit")
        self.hallo = QtWidgets.QPushButton(Form)
        self.hallo.setGeometry(QtCore.QRect(240, 120, 75, 23))
